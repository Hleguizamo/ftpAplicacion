...
class Cliente
{
     ...
     * @var string
     *
     * @ORM\Column(name="direcion", type="string", length=100, nullable=true)
     */
    private $direcion;
     ...
     * @var string
     *
     * @ORM\Column(name="tipo_cliente", type="string", length=1, nullable=true)
     */
    private $tipoCliente;
     ...
     * @var string
     *
     * @ORM\Column(name="codigo_destinatario", type="string", length=20, nullable=true)
     */
     ...
     * @var integer
     *
     * @ORM\Column(name="webservice", type="integer", nullable=true)
     */
    private $webservice;
