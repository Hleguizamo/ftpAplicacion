 ...
 * LogProductos
 *
 * @ORM\Table(name="log_productos", indexes={@ORM\Index(name="log_archivo", columns={"log_archivo"}), @ORM\Index(name="log_admin", columns={"log_admin"})})
 * @ORM\Entity
 */
class LogProductos
{
     ...
     * @var string
     *
     * @ORM\Column(name="contenido", type="string", length=100, nullable=false)
     */
    private $contenido;
